    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <?php
            ...
            $query_crew = "SELECT count(*) as total FROM crew WHERE vessel_id=$id";
            $result_crew = mysql_query($query_crew);
            $row = mysql_fetch_assoc($result_crew);

            $vessel_current_capacity = $row['total'];
        ...
        <form class="form-horizontal" action="main.php?page=vessel_edit_submit&id= <?php echo $vessel_id ?> " method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="number" class="form-control" id="vessel_max_capacity" name="vessel_max_capacity" value="<?php echo $vessel_max_capacity ?>" min="<?php echo $vessel_current_capacity ?>" placeholder="Maximum Capacity">
                </div>
            </div>
